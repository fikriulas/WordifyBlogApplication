...
namespace Wordify.WebUI.Infrastructure
{
    ...
    public class BlogHomePaginationTagHelper : TagHelper
    {
        private IUrlHelperFactory urlHelperFactory;
        public BlogHomePaginationTagHelper(IUrlHelperFactory _urlHelperFactory)
        {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            back.Attributes["href"] = urlHelper.Action(PageAction, new { pg = PageModel.CurrentPage - 1 }); // var olan current page'den bir önceki page'in linkini atar.
            var liback = new TagBuilder("li");
            liback.AddCssClass("page-item");
            if (PageModel.CurrentPage == 1)
            {  //eğer ilk sayfada isek bir sayfa geri gitmeye gerek yok. 
                back.Attributes["href"] = urlHelper.Action(PageAction, new { pg = PageModel.CurrentPage });
            ...
            for (int i = 1; i <= PageModel.TotalPages(); i++)
            {
                ...
                tag.Attributes["href"] = urlHelper.Action(PageAction, new { pg = i });
            ...
            next.Attributes["href"] = urlHelper.Action(PageAction, new { pg = PageModel.CurrentPage + 1 });
            ...
            {  //eğer son sayfada isek bir sayfa ileri gitmeye gerek yok. 
                next.Attributes["href"] = urlHelper.Action(PageAction, new { pg = PageModel.CurrentPage });
